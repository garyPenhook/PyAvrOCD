...
- [Debugging using the dw-link debugger](#quickstart-guide-dw-link-arduino-uno-r3) lowers the entry to serious embedded debugging because the debug probe is an Arduino UNO.
