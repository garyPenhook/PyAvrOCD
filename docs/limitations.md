...
I recently stumbled over a [case](https://gist.github.com/felias-fogg/8f4e1fdb3be14a598467842b03a3aef9) where the compiler had generated debugging information that was wrong. The value of a local variable was not displayed correctly, and it looked as if the value of a local variable had been changed back after an interactive assignment. When [upgrading to a more recent compiler version](troubleshooting.md), things worked out smoothly. A new compiler version might lead to different trouble, though.
