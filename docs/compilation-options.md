...
[^1]: Some cores might still allow disabling LTO in the `Tools` menu. In this case, one needs to disable LTO separately. Other cores, such as megaTinyCore and DxCore, do not allow for disabling LTO at all.
