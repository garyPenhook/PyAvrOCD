...
| `SIGTRAP`            |                                                              | This is not an error signal. Instead, it is issued when execution stops at a place where a BREAK instruction has been placed, and it is not a breakpoint. |
