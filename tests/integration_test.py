...
jtag_arduino =   (on_script, blink_script, mon_script, jbreak_script, flash_script, fib_script,
                      oop_script, tictactoe_script, isr_script, eeprom_script,
                      fuse_script, simhigh_script, off_script)
exotic_arduino =  (on_script, isr_script, off_script)
