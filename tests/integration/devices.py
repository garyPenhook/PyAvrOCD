...
test_devices = {"attiny13" : (micro_clock, ('small', 'arduino', 'dw', 'noadc'),
                ...
                "atmega48" : (mini_clock, ('dw', 'dirty'),
                                    ...
                                    "clock=", "Programmer-ZF"),
                "atmega48a" : (mini_clock, ('medium', 'arduino', 'dw'),
                                    "MiniCore:avr:48:variant=modelNonP,bootloader=no_bootloader," +
                                    "clock=", "Programmer-ZF"),
                "atmega48pa" : (mini_clock, ('medium', 'arduino', 'dw'),
