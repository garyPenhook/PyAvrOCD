...
test_devices = {"attiny13" : (micro_clock, ('small', 'arduino', 'dw', 'noadc'),
                ...
                "at90usb162" : (c_clock, ('large', 'nonarduino', 'dw', 'noadc'), "",
                ...
                "atmega1284p" : (mini_clock, ('huge',  'jtag'),
                                     ...
                                     "MightyCore development board"),
                # Does not work with vanilla GCC 9, therefore only arduino sketches
                "atmega324pb" : (mini_clock, ('large', 'arduino', 'jtag'),
