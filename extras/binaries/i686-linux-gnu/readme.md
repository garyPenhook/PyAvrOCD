...
If, however, this 32-bit tool package ended up on your 64-bit machine, it could be that you installed an Arduino board package through the legacy Arduino IDE, which is a 32-bit Java system. You can get the 64-bit tool package by removing the Arduino board package and reinstalling it from the Ardunio IDE 2.
